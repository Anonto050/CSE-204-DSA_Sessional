...
public class DishwasherTwoArray {
    ...
    public static void main(String[] args) {
        ...
        Integer[] dishStack = new Integer[n*x];

        Arr<Integer> cleanStack = new Arr<Integer>(dishStack,1);
        Arr<Integer> dirtyStack = new Arr<Integer>(dishStack,-1);
